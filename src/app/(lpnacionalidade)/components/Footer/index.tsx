...
import LogoLM from "../../../../../public/assets/images/lb.org-branca.svg";
import LogoJam from "../../../../../public/assets/images/jamilelogo2.svg";
  ...
  return (
    <footer className="bg-brandAccent/20">
      <div className="mx-auto px-4 pt-16 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
        ...
        <div className="flex flex-col-reverse justify-between border-t border-brandSecondary pb-10 pt-5 lg:flex-row">
