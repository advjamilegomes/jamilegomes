        ...
        <div className="relative mx-auto pt-4 sm:pt-2">
          <ul className="grid gap-8 sm:grid-cols-1 lg:grid-cols-3">
            {features.map((item, idx) => (
              <li
                key={idx}
                className="space-y-3 rounded-lg bg-gradient-to-tr from-brandSecondary to-brandAccent p-4 shadow-lg shadow-black/50 hover:transition-all"
              >
                <div className="flex items-center justify-center">
                  <div className="pb-1 text-brandBase2-200">{item.icon}</div>
                </div>
